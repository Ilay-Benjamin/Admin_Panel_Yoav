...
export default class Department {
     ...
     static fromJson(json) {
          ...
          return new Department(jsonData.name, Item.fromJsonArray(JSON.stringify(jsonData.items)));
     }
     ...
     static fromObject(object) {
          return new Department(object.name, Item.fromObjectArray(object.items));
     }
     ...
     static clone() {
          ...
          return new Department(this._name, itemsList);
     }

     equals(department) {
          if (this._name !== department.name || this._items.length !== department.items.length) {
               return false;
          }
